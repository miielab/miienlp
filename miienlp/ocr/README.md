...
**IMPORTANT:** For more details, see the [example](https://github.com/patriChiril/miie_beta/tree/main/examples/ocr) and [How to Run](https://github.com/patriChiril/miie_beta/blob/main/documentation/user_documentation/ocr.md) sections.
